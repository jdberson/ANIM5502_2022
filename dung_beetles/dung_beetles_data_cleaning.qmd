...
db_data <- 
  ...
  # Two individuals remeasured
  filter(!id %in% c("01_M_06", "09_M_255")) %>%
  
  bind_rows(read_xlsx("data/CSIRO project_rpts.xlsx", 
  ...
  # One individual found to have been assigned the incorrect sex - correct here
  mutate(sex = if_else(id == "08_M_01", "F", sex),
         head_horn = if_else(id == "08_M_01", NA_real_, head_horn))
