...
#' 
#' **Important**
#' There are lots of problems with *P* values and null hypothesis significance testing. These are important to be aware of but that is not the focus of this unit. We can discuss these during our next meeting.
#' 
## ------------------------------------------------------------------------------------------------------
...
#' 
#' It could also mean that we lacked the power necessary to detect the effect....
#' 
#' ### Step 5: understand the model results
#' 
## ------------------------------------------------------------------------------------------------------
